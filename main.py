...
def first_menu(update: Update, context: CallbackContext):
  ...
  print(mood)
  update.callback_query.answer()
  update.callback_query.message(text=f"You chose {genre} and {mood}")
...
def first_menu_keyboard():
  keyboard = [[InlineKeyboardButton('Імпрэза', callback_data='Імпрэза')],
              ...
              [InlineKeyboardButton('Іншы', callback_data='Іншы')],
              [InlineKeyboardButton('Прапусціць', callback_data=None)]]
  return InlineKeyboardMarkup(keyboard)
