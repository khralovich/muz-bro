...
HTML_TEMPLATE = jinja2.Template(
    """
    <p>1) {{artist_1}} - {{title_1}} {% for platform in platforms_1 -%} <a href="{{platform.url}}">{{platform.name}}&nbsp;</a>{% endfor %} </p>
    <p>2) {{artist_2}} - {{title_2}} {% for platform in platforms_2 -%} <a href="{{platform.url}}">{{platform.name}}&nbsp;</a>{% endfor %} </p>
    <p>3) {{artist_3}} - {{title_3}} {% for platform in platforms_3 -%} <a href="{{platform.url}}">{{platform.name}}&nbsp;</a>{% endfor %} </p>
    <p>4) {{artist_4}} - {{title_4}} {% for platform in platforms_4 -%} <a href="{{platform.url}}">{{platform.name}}&nbsp;</a>{% endfor %} </p>
    <p>5) {{artist_5}} - {{title_5}} {% for platform in platforms_5 -%} <a href="{{platform.url}}">{{platform.name}}&nbsp;</a>{% endfor %} </p>
    """
)
